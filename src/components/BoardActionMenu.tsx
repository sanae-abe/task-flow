...
const BoardActionMenu = memo<BoardActionMenuProps>(
  ({
    ...
    const trigger: MenuTrigger = useMemo(() => ({
      ...
      className: 'justify-center whitespace-nowrap text-xs font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-foreground h-9 rounded-md px-2 flex items-center gap-1 text-neutral-600'
    }), []);
