...
const InlineMessage: React.FC<InlineMessageProps> = ({
  ...
  if (variant === 'success') {
    ...
    return (
      <div className={`flex items-start text-success ${className} ${gapClass}`}>
        <span className='flex items-center pt-[0.2em]'>
          <SuccessIconComponent size={iconSize} />
        </span>
        <span className={`${fontSizeClass} ${fontWeightClass}`}>{message}</span>
      </div>
    );
  }
  ...
  if (variant === 'warning') {
    ...
    return (
      <div
        className={`flex items-start gap-2 text-warning ${className} ${gapClass}`}
      >
        <span className='flex items-center pt-[0.2em]'>
          <WarningIconComponent size={iconSize} />
        </span>
        <span className={`${fontSizeClass} ${fontWeightClass}`}>{message}</span>
      </div>
    );
  ...
  if (variant === 'critical') {
    ...
    return (
      <div
        className={`flex items-start gap-2 text-destructive ${className} ${gapClass}`}
      >
        <span className='flex items-center pt-[0.2em]'>
          <CriticalIconComponent size={iconSize} />
        </span>
        <span className={`${fontSizeClass} ${fontWeightClass}`}>{message}</span>
      </div>
    );
  ...
  if (variant === 'info') {
    ...
    return (
      <div
        className={`flex items-start gap-2 text-primary ${className} ${gapClass}`}
      >
        <span className='flex items-center pt-[0.2em]'>
          <InfoIconComponent size={iconSize} />
        </span>
        <span className={`${fontSizeClass} ${fontWeightClass}`}>{message}</span>
      </div>
    );
  ...
  return (
    <div
      className={`flex items-start gap-2 text-muted-foreground ${className} ${gapClass}`}
    >
      <span className='flex items-center pt-[0.2em]'>
        <UnavailableIconComponent size={iconSize} />
      </span>
      <span className={`${fontSizeClass} ${fontWeightClass}`}>{message}</span>
    </div>
  );
