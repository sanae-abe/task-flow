...
const validateUrl = (url: string): boolean => {
  ...
  try {
    ...
    const tldPattern =
      /\.(com|org|net|edu|gov|mil|int|co|io|dev|app|tech|info|biz|name|pro|museum|aero|coop|jobs|travel|mobi|asia|cat|tel|xxx|post|geo|local|test|example|localhost|jp|us|uk|de|fr|ca|au|cn|ru|br|mx|in|it|es|nl|se|ch|at|be|dk|no|fi|ie|pt|pl|cz|hu|gr|il|tr|za|my|sg|th|tw|hk|kr|nz|ar|cl|pe|ve|ec|py|uy|bo|co|gf|gy|sr|fk|gs)$/i.test(
        hostname
      );
