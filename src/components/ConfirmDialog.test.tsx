...
describe('ConfirmDialog', () => {
  ...
  describe('Basic rendering', () => {
    ...
    it('should not render dialog when isOpen is false', () => {
      ...
      expect(screen.queryByText('この操作を実行しますか？')).not.toBeInTheDocument()
    })
  ...
  describe('Button text', () => {
    ...
    it('should show custom confirm button text', () => {
      render(
        <ConfirmDialog {...defaultProps} confirmText="実行" />
      )
    ...
    it('should show custom cancel button text', () => {
      render(
        <ConfirmDialog {...defaultProps} cancelText="戻る" />
      )
  ...
  describe('Button interactions', () => {
    ...
    it('should call onConfirm with custom button text', () => {
      render(
        <ConfirmDialog {...defaultProps} confirmText="保存" />
      )
