 ...
 */
import { getBoard, getAllLabels, getTasksByBoard, } from '../../utils/indexeddb.js';
import { generateBoardMarkdown, MarkdownFormat, } from '../../utils/markdown-generator.js';
/**
...
export const exportTools = [
    {
        ...
        description: 'Export a board as Markdown document. Supports multiple formats including Standard Markdown, GitHub-flavored Markdown, and Obsidian-compatible Markdown.',
        inputSchema: {
            type: 'object',
            properties: {
                boardId: {
...
export async function handleExportBoardAsMarkdown(args) {
    try {
        ...
        const format = args.format && args.format in MarkdownFormat
            ? MarkdownFormat[args.format]
 ...
 */
export async function handleExportTool(toolName, args) {
    switch (toolName) {
        case 'export_board_as_markdown':
            return handleExportBoardAsMarkdown(args);
        default:
