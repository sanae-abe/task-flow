 ...
 */
import { getAllTemplates, getTemplate, createTemplate, getBoard, createTask, updateTemplate, deleteTemplate, } from '../../utils/indexeddb.js';
/**
...
export const templateTools = [
    {
        ...
        description: 'Create a reusable task template. Templates can be used to quickly create tasks with predefined properties.',
        inputSchema: {
            type: 'object',
            properties: {
                name: {
    ...
    {
        name: 'list_templates',
        description: 'List all task templates. Can filter by category or favorite status.',
        inputSchema: {
            type: 'object',
            properties: {
                category: {
    ...
    },
    {
        ...
        description: 'Create a new task from an existing template. Applies all template properties to the new task.',
        inputSchema: {
            type: 'object',
            properties: {
                templateId: {
...
export async function handleUpdateTemplate(args) {
    try {
        ...
        if (args.taskData !== undefined)
            updates.taskTemplate = args.taskData;
 ...
 */
export async function handleTemplateTool(toolName, args) {
    switch (toolName) {
        ...
        case 'create_task_from_template':
            return handleCreateTaskFromTemplate(args);
        case 'update_template':
            return handleUpdateTemplate(args);
        case 'delete_template':
            return handleDeleteTemplate(args);
        default:
