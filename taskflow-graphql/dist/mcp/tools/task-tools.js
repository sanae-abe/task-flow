 ...
 */
import { getTask, getAllTasks, getTasksByBoard, createTask as createTaskDB, updateTask as updateTaskDB, } from '../../utils/indexeddb.js';
/**
...
export const taskTools = [
    ...
    },
    {
        ...
        description: 'Update multiple tasks in a single batch operation (Week 7 Performance optimization)',
        inputSchema: {
            type: 'object',
            properties: {
                updates: {
...
export async function handleBatchUpdateTasks(args) {
    try {
        ...
        const results = await Promise.allSettled(args.updates.map(({ taskId, updates }) => updateTaskDB(taskId, updates)));
