 ...
 */
import { getBoard, getAllBoards, createBoard as createBoardDB, updateBoard as updateBoardDB, } from '../../utils/indexeddb.js';
/**
 ...
 */
export async function handleCreateBoard(args) {
    try {
 ...
 */
export async function handleUpdateBoard(args) {
    try {
        const updates = {};
