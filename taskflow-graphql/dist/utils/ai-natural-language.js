 ...
 */
export async function parseNaturalLanguageToTask(query, options = {}) {
    const aiClient = getAIClient();
    const parsedTask = await aiClient.parseNaturalLanguage(query, options.context);
 ...
 */
export function convertToCreateTaskInput(parsed, options) {
...
export function extractEntities(query) {
    ...
    // Date patterns
    const datePatterns = [
        { pattern: /\b(today|tomorrow|tonight)\b/gi, type: 'date' },
        {
            pattern: /\b(next|this) (week|month|monday|tuesday|wednesday|thursday|friday|saturday|sunday)\b/gi,
            type: 'date',
        },
    ...
    const priorityPatterns = [
        ...
        { pattern: /\b(important|high priority)\b/gi, type: 'priority' },
        {
 ...
 */
function calculateParseConfidence(parsed, entities) {
 ...
 */
export function suggestLabels(query) {
 ...
 */
export function extractActionItems(description) {
 ...
 */
export function estimateDuration(query) {
    const queryLower = query.toLowerCase();
...
//# sourceMappingURL=ai-natural-language.js.map